# Skrypt PowerShell do uruchamiania GFS Downloader (FILTERED VERSION - DAEMON)
# Uzycie: .\uruchom_filtered_daemon.ps1

Write-Host ""
Write-Host "========================================"
Write-Host "  GFS Weather Data Downloader"
Write-Host "  FILTERED VERSION - DAEMON MODE"
Write-Host "========================================"
Write-Host ""
...
Write-Host "Daemon bedzie dzialal w tle i:"
Write-Host "  - Automatycznie pobieral nowe prognozy co 30 minut"
Write-Host "  - Ponawial bledne pobrania do skutku (co 2 minuty)"
Write-Host "  - Inteligentnie sprawdzal dostepnosc nowych runow"
Write-Host ""
Write-Host "Aby zatrzymac, nacisnij Ctrl+C"
Write-Host ""
conda run -n gfs314 python gfs_downloader_filtered_daemon.py
